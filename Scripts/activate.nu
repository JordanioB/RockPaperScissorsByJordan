...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Python Projects\RockPaperScissors console game'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Python Projects\RockPaperScissors console game\Scripts\deactivate.nu'
